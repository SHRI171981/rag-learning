...
# Movie review schemas using Pydantic
class Review(BaseModel):
    summary: str = Field(..., description="A brief summary of the movie review.")
    sentiment: str = Field(..., description="The overall sentiment of the review.")


class AnnotatedReview(BaseModel):
    summary: str = Field(..., description="A brief summary of the movie review.")
    sentiment: Literal["Good", "Bad", "Ok"] = Field(..., description="The overall sentiment of the review.")
    key_themes: list[str] = Field(..., description="A list of key themes mentioned in the review.")
    pros: Optional[list[str]] = Field(None, description="A list of pros mentioned in the review. Can be null if not mentioned.")
    cons: Optional[list[str]] = Field(None, description="A list of cons mentioned in the review. Can be null if not mentioned.")
...
print("\nAnnotated Output:")
print(annotated_response.model_dump())
